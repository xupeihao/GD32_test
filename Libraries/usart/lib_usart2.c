...
#define	__USARTx_INDEX		2
#define __USARTx_RCU		RCU_USART2
#define __USARTx			USART2
#define __USARTx_AF			GPIO_AF_7
#define __USARTx_IRQn		USART2_IRQn
#define __USARTx_IRQHandler	USART2_IRQHandler


#define __USARTx_INIT			lib_usart2_init
#define __USARTx_SEND_BYTE		lib_usart2_send_byte
#define __USARTx_SEND_DATA		lib_usart2_send_data
#define __USARTx_SEND_STRING	lib_usart2_send_string
#define __USARTx_ON_RECV		lib_usart2_on_recv

#define __USARTx_RX_CALLBACK	LIB_USART2_RX_CALLBACK

#define __USARTx_ENABLE_TX		LIB_USART2_ENABLE_TX
#define __USARTx_ENABLE_RX		LIB_USART2_ENABLE_RX

#define __USARTx_TX_RCU			LIB_USART2_TX_RCU		
#define __USARTx_TX_PIN			LIB_USART2_TX_PIN

#define __USARTx_RX_RCU			LIB_USART2_RX_RCU		
#define __USARTx_RX_PIN			LIB_USART2_RX_PIN

//// USART config
#define __USARTx_BAUDRATE		LIB_USART2_BAUDRATE		
#define __USARTx_PARITY			LIB_USART2_PARITY		
#define __USARTx_DATA_LEN		LIB_USART2_DATA_LEN		
#define __USARTx_STOPBIT		LIB_USART2_STOPBIT		

#if __USARTx_ENABLE_TX
#define __USARTx_ENABLE_TX_DMA	LIB_USART2_ENABLE_TX_DMA
#if __USARTx_ENABLE_TX_DMA
#define	__USARTx_TX_DMA_RCU		RCU_DMA0
#define __USARTx_TX_DMA_CH		DMA0, DMA_CH3
#define __USARTx_TX_DMA_CH_SUB	DMA_SUBPERI4
#endif
#endif
#if __USARTx_ENABLE_RX
#define __USARTx_ENABLE_RX_DMA	LIB_USART2_ENABLE_RX_DMA
#define __USARTx_RX_LEN			LIB_USART2_RX_LEN
#if __USARTx_ENABLE_RX_DMA
#include <string.h>
#define	__USARTx_RX_DMA_RCU		RCU_DMA0
#define __USARTx_RX_DMA_CH		DMA0, DMA_CH1
#define __USARTx_RX_DMA_CH_SUB	DMA_SUBPERI4
#endif
