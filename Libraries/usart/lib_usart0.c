...
#define	__USARTx_INDEX		0
#define __USARTx_RCU		RCU_USART0
#define __USARTx			USART0
#define __USARTx_AF			GPIO_AF_7
#define __USARTx_IRQn		USART0_IRQn
#define __USARTx_IRQHandler	USART0_IRQHandler


#define __USARTx_INIT			lib_usart0_init
#define __USARTx_SEND_BYTE		lib_usart0_send_byte
#define __USARTx_SEND_DATA		lib_usart0_send_data
#define __USARTx_SEND_STRING	lib_usart0_send_string
#define __USARTx_ON_RECV		lib_usart0_on_recv

#define __USARTx_RX_CALLBACK	LIB_USART0_RX_CALLBACK

#define __USARTx_ENABLE_TX		LIB_USART0_ENABLE_TX
#define __USARTx_ENABLE_RX		LIB_USART0_ENABLE_RX

#define __USARTx_TX_RCU			LIB_USART0_TX_RCU		
#define __USARTx_TX_PIN			LIB_USART0_TX_PIN

#define __USARTx_RX_RCU			LIB_USART0_RX_RCU		
#define __USARTx_RX_PIN			LIB_USART0_RX_PIN

//// USART config
#define __USARTx_BAUDRATE		LIB_USART0_BAUDRATE		
#define __USARTx_PARITY			LIB_USART0_PARITY		
#define __USARTx_DATA_LEN		LIB_USART0_DATA_LEN		
#define __USARTx_STOPBIT		LIB_USART0_STOPBIT		

#if __USARTx_ENABLE_TX
#define __USARTx_ENABLE_TX_DMA	LIB_USART0_ENABLE_TX_DMA
#if __USARTx_ENABLE_TX_DMA
#define	__USARTx_TX_DMA_RCU		RCU_DMA1
#define __USARTx_TX_DMA_CH		DMA1, DMA_CH7
#define __USARTx_TX_DMA_CH_SUB	DMA_SUBPERI4
#endif
#endif
#if __USARTx_ENABLE_RX
#define __USARTx_ENABLE_RX_DMA	LIB_USART0_ENABLE_RX_DMA
#define __USARTx_RX_LEN			LIB_USART0_RX_LEN
#if __USARTx_ENABLE_RX_DMA
#include <string.h>
#define	__USARTx_RX_DMA_RCU		LIB_USART0_RX_DMA_RCU
#define __USARTx_RX_DMA_CH		LIB_USART0_RX_DMA_CH
