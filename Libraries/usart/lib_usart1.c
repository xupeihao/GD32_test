...
#define	__USARTx_INDEX		1
#define __USARTx_RCU		RCU_USART1
#define __USARTx			USART1
#define __USARTx_AF			GPIO_AF_7
#define __USARTx_IRQn		USART1_IRQn
#define __USARTx_IRQHandler	USART1_IRQHandler


#define __USARTx_INIT			lib_usart1_init
#define __USARTx_SEND_BYTE		lib_usart1_send_byte
#define __USARTx_SEND_DATA		lib_usart1_send_data
#define __USARTx_SEND_STRING	lib_usart1_send_string
#define __USARTx_ON_RECV		lib_usart1_on_recv

#define __USARTx_RX_CALLBACK	LIB_USART1_RX_CALLBACK

#define __USARTx_ENABLE_TX		LIB_USART1_ENABLE_TX
#define __USARTx_ENABLE_RX		LIB_USART1_ENABLE_RX

#define __USARTx_TX_RCU			LIB_USART1_TX_RCU		
#define __USARTx_TX_PIN			LIB_USART1_TX_PIN

#define __USARTx_RX_RCU			LIB_USART1_RX_RCU		
#define __USARTx_RX_PIN			LIB_USART1_RX_PIN

//// USART config
#define __USARTx_BAUDRATE		LIB_USART1_BAUDRATE		
#define __USARTx_PARITY			LIB_USART1_PARITY		
#define __USARTx_DATA_LEN		LIB_USART1_DATA_LEN		
#define __USARTx_STOPBIT		LIB_USART1_STOPBIT		

#if __USARTx_ENABLE_TX
#define __USARTx_ENABLE_TX_DMA	LIB_USART1_ENABLE_TX_DMA
#if __USARTx_ENABLE_TX_DMA
#define	__USARTx_TX_DMA_RCU		RCU_DMA0
#define __USARTx_TX_DMA_CH		DMA0, DMA_CH6
#define __USARTx_TX_DMA_CH_SUB	DMA_SUBPERI4
#endif
#endif
#if __USARTx_ENABLE_RX
#define __USARTx_ENABLE_RX_DMA	LIB_USART1_ENABLE_RX_DMA
#define __USARTx_RX_LEN			LIB_USART1_RX_LEN
#if __USARTx_ENABLE_RX_DMA
#include <string.h>
#define	__USARTx_RX_DMA_RCU		RCU_DMA0
#define __USARTx_RX_DMA_CH		DMA0, DMA_CH5
