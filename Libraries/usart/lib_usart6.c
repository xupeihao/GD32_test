...
#define	__USARTx_INDEX		6
#define __USARTx_RCU		RCU_UART6
#define __USARTx			UART6
#define __USARTx_AF			GPIO_AF_8
#define __USARTx_IRQn		UART6_IRQn
#define __USARTx_IRQHandler	UART6_IRQHandler


#define __USARTx_INIT			lib_usart6_init
#define __USARTx_SEND_BYTE		lib_usart6_send_byte
#define __USARTx_SEND_DATA		lib_usart6_send_data
#define __USARTx_SEND_STRING	lib_usart6_send_string
#define __USARTx_ON_RECV		lib_usart6_on_recv

#define __USARTx_RX_CALLBACK	LIB_USART6_RX_CALLBACK

#define __USARTx_ENABLE_TX		LIB_USART6_ENABLE_TX
#define __USARTx_ENABLE_RX		LIB_USART6_ENABLE_RX

#define __USARTx_TX_RCU			LIB_USART6_TX_RCU		
#define __USARTx_TX_PIN			LIB_USART6_TX_PIN

#define __USARTx_RX_RCU			LIB_USART6_RX_RCU		
#define __USARTx_RX_PIN			LIB_USART6_RX_PIN

//// USART config
#define __USARTx_BAUDRATE		LIB_USART6_BAUDRATE		
#define __USARTx_PARITY			LIB_USART6_PARITY		
#define __USARTx_DATA_LEN		LIB_USART6_DATA_LEN		
#define __USARTx_STOPBIT		LIB_USART6_STOPBIT		

#if __USARTx_ENABLE_TX
#define __USARTx_ENABLE_TX_DMA	LIB_USART6_ENABLE_TX_DMA
#if __USARTx_ENABLE_TX_DMA
#define	__USARTx_TX_DMA_RCU		RCU_DMA0
#define __USARTx_TX_DMA_CH		DMA0, DMA_CH1
#define __USARTx_TX_DMA_CH_SUB	DMA_SUBPERI5
#endif
#endif
#if __USARTx_ENABLE_RX
#define __USARTx_ENABLE_RX_DMA	LIB_USART6_ENABLE_RX_DMA
#define __USARTx_RX_LEN			LIB_USART6_RX_LEN
#if __USARTx_ENABLE_RX_DMA
#include <string.h>
#define	__USARTx_RX_DMA_RCU		RCU_DMA0
#define __USARTx_RX_DMA_CH		DMA0, DMA_CH3
