...
#define __SPIx				SPI2
#define __SPIx_RCU		RCU_SPI2

#define __SPIx_USE_MOSI	LIB_SPI2_USE_MOSI
#define __SPIx_USE_MISO	LIB_SPI2_USE_MISO

#define __SPIx_CLK_RCU	LIB_SPI2_CLK_RCU
#define __SPIx_CLK_PIN	LIB_SPI2_CLK_PIN

#define __SPIx_MOSI_RCU	LIB_SPI2_MOSI_RCU
#define __SPIx_MOSI_PIN	LIB_SPI2_MOSI_PIN

#define __SPIx_MISO_RCU	LIB_SPI2_MISO_RCU
#define __SPIx_MISO_PIN	LIB_SPI2_MISO_PIN

#define __SPIx_PLPH		LIB_SPI2_PLPH
#define __SPIx_PSC		LIB_SPI2_PSC
#define __SPIx_ENDIAN	LIB_SPI2_ENDIAN


#if __SPIx_USE_MOSI
#define __SPIx_MOSI_USE_DMA	LIB_SPI2_MOSI_USE_DMA
#if __SPIx_MOSI_USE_DMA
#define __SPIx_DMA_RCU				RCU_DMA0
#define __SPIx_DMA_CH				DMA0, DMA_CH5
#define __SPIx_DMA_CH_SUB			DMA_SUBPERI0
#define __SPIx_DMA_FUNC_WRITE		lib_spi2_dma_write
#define __SPIx_DMA_FUNC_ON_COMPLETE	lib_spi2_dma_on_complete
#define __SPIx_DMA_FUNC_WRITE_IRQ	DMA0_Channel5_IRQHandler
#endif
#endif

#define __SPIx_FUNC_INIT		lib_spi2_init
#define __SPIx_FUNC_WRITE		lib_spi2_write
#define __SPIx_FUNC_READ		lib_spi2_read
#define __SPIx_FUNC_WRITE_READ	lib_spi2_write_read
...
void __SPIx_FUNC_INIT() {
	///// gpio初始化
	////////////// GPIO ////////////////
	spi_io_init(__SPIx_CLK_RCU, __SPIx_CLK_PIN, GPIO_AF_6);//clk
#if __SPIx_USE_MOSI
	spi_io_init(__SPIx_MOSI_RCU,__SPIx_MOSI_PIN, GPIO_AF_6);//mosi
#endif
#if __SPIx_USE_MISO
