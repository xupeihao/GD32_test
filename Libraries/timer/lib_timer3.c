...
#define __TIMERx_IRQn		TIMER3_IRQn
///// 查手册
#define __TIMERx_AF			GPIO_AF_2

#define __TIMERx_PSC		LIB_TIMER3_PSC
#define __TIMERx_FREQ		LIB_TIMER3_FREQ

#define __TIMERx_MODE				LIB_TIMER3_MODE
#define __TIMERx_FUNC_INIT			lib_timer3_init
#define __TIMERx_FUNC_UPDATE_PERIOD	lib_timer3_update_period

#if __TIMERx_MODE == 0
#define __TIMERx_NVIC		LIB_TIMER3_NVIC
#define __TIMERx_CB			LIB_TIMER3_CB

#define __TIMERx_FUNC_IRQ	TIMER3_IRQHandler
#define __TIMERx_FUNC_CB	lib_timer3_on_cb
#elif __TIMERx_MODE == 1

#define __TIMERx_USE_CH0	LIB_TIMER3_USE_CH0
#define __TIMERx_USE_CH1	LIB_TIMER3_USE_CH1
#define __TIMERx_USE_CH2	LIB_TIMER3_USE_CH2
#define __TIMERx_USE_CH3	LIB_TIMER3_USE_CH3

#if __TIMERx_USE_CH0
#define __TIMERx_CH0_RCU		LIB_TIMER3_CH0_RCU
#define __TIMERx_CH0_PIN		LIB_TIMER3_CH0_PIN
#define __TIMERx_CH0_MODE		LIB_TIMER3_CH0_MODE
#define __TIMERx_CH0_DUTY		LIB_TIMER3_CH0_DUTY
#define __TIMERx_CH0_FUNC_DUTY	lib_timer3_ch0_duty
#endif
#if __TIMERx_USE_CH1
#define __TIMERx_CH1_RCU		LIB_TIMER3_CH1_RCU
#define __TIMERx_CH1_PIN		LIB_TIMER3_CH1_PIN
#define __TIMERx_CH1_MODE		LIB_TIMER3_CH1_MODE
#define __TIMERx_CH1_DUTY		LIB_TIMER3_CH1_DUTY
#define __TIMERx_CH1_FUNC_DUTY	lib_timer3_ch1_duty
#endif
#if __TIMERx_USE_CH2
#define __TIMERx_CH2_RCU		LIB_TIMER3_CH2_RCU
#define __TIMERx_CH2_PIN		LIB_TIMER3_CH2_PIN
#define __TIMERx_CH2_MODE		LIB_TIMER3_CH2_MODE
#define __TIMERx_CH2_DUTY		LIB_TIMER3_CH2_DUTY
#define __TIMERx_CH2_FUNC_DUTY	lib_timer3_ch2_duty
#endif
#if __TIMERx_USE_CH3
#define __TIMERx_CH3_RCU		LIB_TIMER3_CH3_RCU
#define __TIMERx_CH3_PIN		LIB_TIMER3_CH3_PIN
#define __TIMERx_CH3_MODE		LIB_TIMER3_CH3_MODE
#define __TIMERx_CH3_DUTY		LIB_TIMER3_CH3_DUTY
#define __TIMERx_CH3_FUNC_DUTY	lib_timer3_ch3_duty
#endif
