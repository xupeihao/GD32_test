...
#define __TIMERx_NVIC		LIB_TIMER5_NVIC
#define __TIMERx_PSC		LIB_TIMER5_PSC
#define __TIMERx_FREQ		LIB_TIMER5_FREQ
#define __TIMERx_CB			LIB_TIMER5_CB

#define __TIMERx_FUNC_INIT	lib_timer5_init
#define __TIMERx_FUNC_IRQ	TIMER5_DAC_IRQHandler
#define __TIMERx_FUNC_CB	lib_timer5_on_cb
