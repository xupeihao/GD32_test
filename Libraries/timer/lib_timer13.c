...
#define __TIMERx_RCU		RCU_TIMER13
#define __TIMERx			TIMER13
#define __TIMERx_IRQn		TIMER13_IRQn
///// 查手册
#define __TIMERx_AF			GPIO_AF_9

#define __TIMERx_PSC		LIB_TIMER13_PSC
#define __TIMERx_FREQ		LIB_TIMER13_FREQ

#define __TIMERx_MODE				LIB_TIMER13_MODE
#define __TIMERx_FUNC_INIT			lib_timer13_init
#define __TIMERx_FUNC_UPDATE_PERIOD	lib_timer13_update_period

#if __TIMERx_MODE == 0
#define __TIMERx_NVIC		LIB_TIMER13_NVIC
#define __TIMERx_CB			LIB_TIMER13_CB

#define __TIMERx_FUNC_IRQ	TIMER13_IRQHandler
#define __TIMERx_FUNC_CB	lib_timer13_on_cb
#elif __TIMERx_MODE == 1

#define __TIMERx_USE_CH0	LIB_TIMER13_USE_CH0

#if __TIMERx_USE_CH0
#define __TIMERx_CH0_RCU		LIB_TIMER13_CH0_RCU
#define __TIMERx_CH0_PIN		LIB_TIMER13_CH0_PIN
#define __TIMERx_CH0_MODE		LIB_TIMER13_CH0_MODE
#define __TIMERx_CH0_DUTY		LIB_TIMER13_CH0_DUTY
#define __TIMERx_CH0_FUNC_DUTY	lib_timer13_ch0_duty
#endif
