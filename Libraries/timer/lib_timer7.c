...
#define __TIMERx_IRQn		TIMER7_IRQn
///// 查手册
#define __TIMERx_AF			GPIO_AF_3

#define __TIMERx_PSC		LIB_TIMER7_PSC
#define __TIMERx_FREQ		LIB_TIMER7_FREQ

#define __TIMERx_MODE				LIB_TIMER7_MODE
#define __TIMERx_FUNC_INIT			lib_timer7_init
#define __TIMERx_FUNC_UPDATE_PERIOD	lib_timer7_update_period

#if __TIMERx_MODE == 0
#define __TIMERx_NVIC		LIB_TIMER7_NVIC
#define __TIMERx_CB			LIB_TIMER7_CB

#define __TIMERx_FUNC_IRQ	TIMER7_IRQHandler
#define __TIMERx_FUNC_CB	lib_timer7_on_cb
#elif __TIMERx_MODE == 1

#define __TIMERx_USE_CH0_P	LIB_TIMER7_USE_CH0_P
#define __TIMERx_USE_CH0_N	LIB_TIMER7_USE_CH0_N
#define __TIMERx_USE_CH1_P	LIB_TIMER7_USE_CH1_P
#define __TIMERx_USE_CH1_N	LIB_TIMER7_USE_CH1_N
#define __TIMERx_USE_CH2_P	LIB_TIMER7_USE_CH2_P
#define __TIMERx_USE_CH2_N	LIB_TIMER7_USE_CH2_N
#define __TIMERx_USE_CH3	LIB_TIMER7_USE_CH3

#if __TIMERx_USE_CH0_P
#define __TIMERx_CH0_P_RCU		LIB_TIMER7_CH0_P_RCU
#define __TIMERx_CH0_P_PIN		LIB_TIMER7_CH0_P_PIN
#endif
#if __TIMERx_USE_CH0_N
#define __TIMERx_CH0_N_RCU		LIB_TIMER7_CH0_N_RCU
#define __TIMERx_CH0_N_PIN		LIB_TIMER7_CH0_N_PIN
#endif
#if __TIMERx_USE_CH0_P || __TIMERx_USE_CH0_N
#define __TIMERx_CH0_MODE		LIB_TIMER7_CH0_MODE
#define __TIMERx_CH0_DUTY		LIB_TIMER7_CH0_DUTY
#define __TIMERx_CH0_FUNC_DUTY	lib_timer7_ch0_duty
#endif

#if __TIMERx_USE_CH1_P
#define __TIMERx_CH1_P_RCU		LIB_TIMER7_CH1_P_RCU
#define __TIMERx_CH1_P_PIN		LIB_TIMER7_CH1_P_PIN
#endif
#if __TIMERx_USE_CH1_N
#define __TIMERx_CH1_N_RCU		LIB_TIMER7_CH1_N_RCU
#define __TIMERx_CH1_N_PIN		LIB_TIMER7_CH1_N_PIN
#endif
#if __TIMERx_USE_CH1_P || __TIMERx_USE_CH1_N
#define __TIMERx_CH1_MODE		LIB_TIMER7_CH1_MODE
#define __TIMERx_CH1_DUTY		LIB_TIMER7_CH1_DUTY
#define __TIMERx_CH1_FUNC_DUTY	lib_timer7_ch1_duty
#endif

#if __TIMERx_USE_CH2_P
#define __TIMERx_CH2_P_RCU		LIB_TIMER7_CH2_P_RCU
#define __TIMERx_CH2_P_PIN		LIB_TIMER7_CH2_P_PIN
#endif
#if __TIMERx_USE_CH2_N
#define __TIMERx_CH2_N_RCU		LIB_TIMER7_CH2_N_RCU
#define __TIMERx_CH2_N_PIN		LIB_TIMER7_CH2_N_PIN
#endif
#if __TIMERx_USE_CH2_P || __TIMERx_USE_CH2_N
#define __TIMERx_CH2_MODE		LIB_TIMER7_CH2_MODE
#define __TIMERx_CH2_DUTY		LIB_TIMER7_CH2_DUTY
#define __TIMERx_CH2_FUNC_DUTY	lib_timer7_ch2_duty
#endif

#if __TIMERx_USE_CH3
#define __TIMERx_CH3_RCU		LIB_TIMER7_CH3_RCU
#define __TIMERx_CH3_PIN		LIB_TIMER7_CH3_PIN
#define __TIMERx_CH3_MODE		LIB_TIMER7_CH3_MODE
#define __TIMERx_CH3_DUTY		LIB_TIMER7_CH3_DUTY
#define __TIMERx_CH3_FUNC_DUTY	lib_timer7_ch3_duty
#endif
