...
#define __TIMERx_IRQn		TIMER9_IRQn
///// 查手册
#define __TIMERx_AF			GPIO_AF_3

#define __TIMERx_PSC		LIB_TIMER9_PSC
#define __TIMERx_FREQ		LIB_TIMER9_FREQ

#define __TIMERx_MODE				LIB_TIMER9_MODE
#define __TIMERx_FUNC_INIT			lib_timer9_init
#define __TIMERx_FUNC_UPDATE_PERIOD	lib_timer9_update_period

#if __TIMERx_MODE == 0
#define __TIMERx_NVIC		LIB_TIMER9_NVIC
#define __TIMERx_CB			LIB_TIMER9_CB

#define __TIMERx_FUNC_IRQ	TIMER9_IRQHandler
#define __TIMERx_FUNC_CB	lib_timer9_on_cb
#elif __TIMERx_MODE == 1

#define __TIMERx_USE_CH0	LIB_TIMER9_USE_CH0

#if __TIMERx_USE_CH0
#define __TIMERx_CH0_RCU		LIB_TIMER9_CH0_RCU
#define __TIMERx_CH0_PIN		LIB_TIMER9_CH0_PIN
#define __TIMERx_CH0_MODE		LIB_TIMER9_CH0_MODE
#define __TIMERx_CH0_DUTY		LIB_TIMER9_CH0_DUTY
#define __TIMERx_CH0_FUNC_DUTY	lib_timer9_ch0_duty
#endif
