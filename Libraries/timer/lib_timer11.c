...
#define __TIMERx_RCU		RCU_TIMER11
#define __TIMERx			TIMER11
#define __TIMERx_IRQn		TIMER11_IRQn
///// 查手册
#define __TIMERx_AF			GPIO_AF_9

#define __TIMERx_PSC		LIB_TIMER11_PSC
#define __TIMERx_FREQ		LIB_TIMER11_FREQ

#define __TIMERx_MODE				LIB_TIMER11_MODE
#define __TIMERx_FUNC_INIT			lib_timer11_init
#define __TIMERx_FUNC_UPDATE_PERIOD	lib_timer11_update_period

#if __TIMERx_MODE == 0
#define __TIMERx_NVIC		LIB_TIMER11_NVIC
#define __TIMERx_CB			LIB_TIMER11_CB

#define __TIMERx_FUNC_IRQ	TIMER11_IRQHandler
#define __TIMERx_FUNC_CB	lib_timer11_on_cb
#elif __TIMERx_MODE == 1

#define __TIMERx_USE_CH0	LIB_TIMER11_USE_CH0
#define __TIMERx_USE_CH1	LIB_TIMER11_USE_CH1

#if __TIMERx_USE_CH0
#define __TIMERx_CH0_RCU		LIB_TIMER11_CH0_RCU
#define __TIMERx_CH0_PIN		LIB_TIMER11_CH0_PIN
#define __TIMERx_CH0_MODE		LIB_TIMER11_CH0_MODE
#define __TIMERx_CH0_DUTY		LIB_TIMER11_CH0_DUTY
#define __TIMERx_CH0_FUNC_DUTY	lib_timer11_ch0_duty
#endif
#if __TIMERx_USE_CH1
#define __TIMERx_CH1_RCU		LIB_TIMER11_CH1_RCU
#define __TIMERx_CH1_PIN		LIB_TIMER11_CH1_PIN
#define __TIMERx_CH1_MODE		LIB_TIMER11_CH1_MODE
#define __TIMERx_CH1_DUTY		LIB_TIMER11_CH1_DUTY
#define __TIMERx_CH1_FUNC_DUTY	lib_timer11_ch1_duty
#endif
