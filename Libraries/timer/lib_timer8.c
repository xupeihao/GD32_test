...
#define __TIMERx_RCU		RCU_TIMER8
#define __TIMERx			TIMER8
#define __TIMERx_IRQn		TIMER8_IRQn
///// 查手册
#define __TIMERx_AF			GPIO_AF_3

#define __TIMERx_PSC		LIB_TIMER8_PSC
#define __TIMERx_FREQ		LIB_TIMER8_FREQ

#define __TIMERx_MODE				LIB_TIMER8_MODE
#define __TIMERx_FUNC_INIT			lib_timer8_init
#define __TIMERx_FUNC_UPDATE_PERIOD	lib_timer8_update_period

#if __TIMERx_MODE == 0
#define __TIMERx_NVIC		LIB_TIMER8_NVIC
#define __TIMERx_CB			LIB_TIMER8_CB

#define __TIMERx_FUNC_IRQ	TIMER8_IRQHandler
#define __TIMERx_FUNC_CB	lib_timer8_on_cb
#elif __TIMERx_MODE == 1

#define __TIMERx_USE_CH0	LIB_TIMER8_USE_CH0
#define __TIMERx_USE_CH1	LIB_TIMER8_USE_CH1

#if __TIMERx_USE_CH0
#define __TIMERx_CH0_RCU		LIB_TIMER8_CH0_RCU
#define __TIMERx_CH0_PIN		LIB_TIMER8_CH0_PIN
#define __TIMERx_CH0_MODE		LIB_TIMER8_CH0_MODE
#define __TIMERx_CH0_DUTY		LIB_TIMER8_CH0_DUTY
#define __TIMERx_CH0_FUNC_DUTY	lib_timer8_ch0_duty
#endif
#if __TIMERx_USE_CH1
#define __TIMERx_CH1_RCU		LIB_TIMER8_CH1_RCU
#define __TIMERx_CH1_PIN		LIB_TIMER8_CH1_PIN
#define __TIMERx_CH1_MODE		LIB_TIMER8_CH1_MODE
#define __TIMERx_CH1_DUTY		LIB_TIMER8_CH1_DUTY
#define __TIMERx_CH1_FUNC_DUTY	lib_timer8_ch1_duty
#endif
