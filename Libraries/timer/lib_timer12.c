...
#define __TIMERx_RCU		RCU_TIMER12
#define __TIMERx			TIMER12
#define __TIMERx_IRQn		TIMER12_IRQn
///// 查手册
#define __TIMERx_AF			GPIO_AF_9

#define __TIMERx_PSC		LIB_TIMER12_PSC
#define __TIMERx_FREQ		LIB_TIMER12_FREQ

#define __TIMERx_MODE				LIB_TIMER12_MODE
#define __TIMERx_FUNC_INIT			lib_timer12_init
#define __TIMERx_FUNC_UPDATE_PERIOD	lib_timer12_update_period

#if __TIMERx_MODE == 0
#define __TIMERx_NVIC		LIB_TIMER12_NVIC
#define __TIMERx_CB			LIB_TIMER12_CB

#define __TIMERx_FUNC_IRQ	TIMER12_IRQHandler
#define __TIMERx_FUNC_CB	lib_timer12_on_cb
#elif __TIMERx_MODE == 1

#define __TIMERx_USE_CH0	LIB_TIMER12_USE_CH0

#if __TIMERx_USE_CH0
#define __TIMERx_CH0_RCU		LIB_TIMER12_CH0_RCU
#define __TIMERx_CH0_PIN		LIB_TIMER12_CH0_PIN
#define __TIMERx_CH0_MODE		LIB_TIMER12_CH0_MODE
#define __TIMERx_CH0_DUTY		LIB_TIMER12_CH0_DUTY
#define __TIMERx_CH0_FUNC_DUTY	lib_timer12_ch0_duty
#endif
